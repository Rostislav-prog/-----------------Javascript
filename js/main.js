...
const goodlist = new GoodList(API.fetch()); // обьект с товарами , с присвоеными id
// console.log(goodlist);

const $cards = goodlist.get().map(good => new Card(good)); // карточки товаров

const $product = document.querySelector('.catalog_js');
...
// const arrFetch = API.fetch(); // массив с обьектами - каталог товаров, принятый с сервера

// let fetchIndex = arrFetch.slice(5); //укороченный обьект товаров для первой страницы

// const goodlistIndex = new GoodList(fetchIndex); // обьект с товарами для index , с присвоеными id

// const $cardsIndex = goodlistIndex.get().map(good => new Card(good)); // карточки товаров для index
// console.log($cardsIndex);

// const $productIndex = document.querySelector('.index_js');
// console.log($productIndex);

// $cardsIndex.forEach($card => {
//     $card.render($productIndex);
// });                                                       // НЕ РАБОТАЕТ!!!!
